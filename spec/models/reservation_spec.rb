...
RSpec.describe CarAppointmentBackend, type: :model do
  ...
  let(:car) do
    Car.create(name: 'Ford', model: 'Focus', engine: '1.6', image: 'image.jpg', price: '100', seats: '5', year: '2010',
               user: user)
  end
  let(:appointment) do
    Appointment.create(user_id: user.id, car_id: car.id, start_time: '2020-01-01', end_time: '2020-01-01',
                       status: 'pending')
  end
